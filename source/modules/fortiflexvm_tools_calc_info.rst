...
.. raw:: html
 ...
 <li><span class="li-head">playbooks</span> Quantity of Playbooks.<span class="li-normal">type: int</span></li>
 <li><span class="li-head">eps</span> Quantity of EPS.<span class="li-normal">type: int</span></li>
 <li><span class="li-head">addons</span> Add-on services. A list, can be empty. Possible value is "FNDTLI" (3rd-Party Log Intake). 3rd-Party Log Intake must be active for at least 90 straight days once enabled.<span class="li-normal">type: list</span><span class="li-normal">default: []</span></li>
    ...
    tasks:
      - name: Estimate cost
        fortinet.fortiflexvm.fortiflexvm_tools_calc_info:
          ...
          # [FortiNDR Cloud]
          # fortiNDRCloud:
          #   meteredUsage: 100                 # 0 or 100 ~ 10000000. Value should be divisible by 100. (Read-only variable)
          #   playbooks: 500                    # 0 or 500 ~ 1000000. Value should be divisible by 100. (Read-only variable)
          #   eps: 100                          # 0 or 100 ~ 1000000. Value should be divisible by 100. (Read-only variable)
